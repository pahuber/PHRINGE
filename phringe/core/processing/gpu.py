...
def _calculate_complex_amplitude(base_complex_amplitude: Tensor,
                                 polarization_perturbation_time_series: Tensor) -> Tensor:
...
def _calculate_intensity_response(complex_amplitude_x: Tensor,
                                  complex_amplitude_y: Tensor,
                                  beam_combination_matrix: Tensor) -> torch.tensor:
