...
* | **Fast Computations:**
  | Run *PHRINGE* on GPU (in addition to CPU) to speed up computations thanks to the integration of `PyTorch <https://pytorch.org>`_.
* | **Support for NIFITS Data Standard:**
  | Export your synthetic data sets as NIFITS files thanks to the integration of `nifits <https://www.github.com/rlaugier/nifits>`_.
